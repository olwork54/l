...
(function () {
  ...
  var FormWizard = /*#__PURE__*/function () {
    ...
    _createClass(FormWizard, [{
      ...
      key: "toCloseWindow",
      value: function toCloseWindow() {
        console.log('toCloseWindow');
      }
    }, {
      key: "toStep",
      ...
      value: function validate(stepEl) {
        ...
        inputs.forEach(function (inputEl) {
          if (inputEl.name === 'tel') {
            error = _this11.validateTel(inputEl);
          }

          if (inputEl.name === 'name') {
            error = _this11.validateName(inputEl);
          } else if (inputEl.name === 'email') {
            error = _this11.validateEmail(inputEl);
          }
        });
        return !error;
      }
      ...
      value: function updateHeroMsg(elem) {
        var heroMsgElems = document.querySelectorAll('.hero-msg');
        heroMsgElems.forEach(function (el) {
      ...
      key: "toggleCloseWindow",
      value: function toggleCloseWindow() {
        var zipModal = document.querySelector('.quiz.modal');
        var shureModal = document.querySelector('.are-you-shure');
      ...
      value: function init() {
        ...
        this.steps.forEach(function (stepEl) {
          var applyBtn = stepEl.querySelector(_this12.applyBtnSelector);
          ...
          inputs.forEach(function (inputEl) {
            if (inputEl.type === 'radio') {
              ...
              inputEl.addEventListener('input', function (e) {
                ...
                _this12.updateConfirmPhone(e.target.value);
              });
            }
          });
          noBtn.addEventListener('click', function (e) {
            ...
            _this12.toggleCloseWindow();
          });
          yesBtn.addEventListener('click', function (e) {
            e.preventDefault();

            if (_this12.validate(stepEl)) {
              _this12.nextStep();
            }
          });
  ...
  function zipCodeHeandler() {
    ...
    zipInputs.forEach(function (input) {
      ...
      form.addEventListener('submit', function (e) {
        e.preventDefault();
        if (input.value.length === 6) openModal(input.value), form.reset();else errorMsg.innerText = 'Enter valid zip-code';
      });
